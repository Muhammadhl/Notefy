            ...
            if (mediaPlayer != null) {
                prepareMediaPlayer();
                 if (countIn) {
                     ...
                     if (!playControls.getMetronomeEnabled()) // count-in bar has metronome tick notes in the MIDI file, else if count-in and no metronome we start playing the midi _after_ the count-in
